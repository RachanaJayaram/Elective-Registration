...
{  
    ...
    if(isset($db))
    {
      $str="SELECT ADMIN_EMAIL FROM ADMIN_LOGIN WHERE ADMIN_EMAIL = \"".$_POST['email']."\";";
    //   echo $str;
    ...
    //   }
      ...
      {
        mysqli_query($db,"DELETE FROM ADMIN_LOGIN WHERE ADMIN_EMAIL=\"".$_POST['email']."\";");
        ...
        // echo $hashed_token;
        $insert_token_deets="INSERT INTO ADMIN_LOGIN VALUES(\"".$_POST['email']."\",null,\"$hashed_token\");";
        mysqli_query($db, $insert_token_deets);
   
        $to = $_POST['email'];
        $subject = "Password Setting";
        $txt = "Follow this link to change your admin password: http://localhost:8080/dbms/change_admin_password.php?token=$hex";
                    ...
                    <div class="d-flex justify-content-center h-100 align-items-center">
                        <div class="card"  style="background-color: rgba(3, 8, 75, 0.719);">
                            ...
                            <div class="card-body">
                                    ...
                                    <a href="admin_login.html" class="btn login_btn" id="login_btn" >Go Back </a> 
