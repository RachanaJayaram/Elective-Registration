...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    if(isset($_GET['token']))
    {
        ...
        if(isset($db))
        {
            ...
            $str="SELECT ADMIN_EMAIL FROM ADMIN_LOGIN WHERE TOKEN = \"".$hashed_token."\";";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update="UPDATE  ADMIN_LOGIN SET ADMIN_PASSWORD=\"".$hashed_password."\",TOKEN='NULL' WHERE ADMIN_EMAIL=\"".trim($_POST['email'])."\";";
    echo $update;
    mysqli_query($db, $update);
    header("Location: http://localhost:8080/dbms/Admin_login.html");
    die();
}
                ...
                <div class="card-body">
                    <form  action="change_admin_password.php" method="POST">
                        ...
                        <div class="input-group form-group">
                            ...
                            <input  name="email" type="text" class="form-control" readonly = "readonly" placeholder="Email Id" value=" <?php echo trim($Email_id); ?>">
                        </div>
                        <div class="input-group form-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
